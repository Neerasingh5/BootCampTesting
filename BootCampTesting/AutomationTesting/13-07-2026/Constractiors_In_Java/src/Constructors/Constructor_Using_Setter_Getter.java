...
public class Constructor_Using_Setter_Getter {
     public static void main(String[] args) {
            ...
            Employee Neeraj = new Employee(143, "Neeraj Singh");

            // Setting remaining values using setters
            Neeraj.setSalary(75000.0f);
            Neeraj.setSsn("123-45-6789");

            // Displaying values using getters
            System.out.println("Employee ID: " + Neeraj.getId());
            System.out.println("Employee Name: " + Neeraj.getName());
            System.out.println("Employee Salary: " + Neeraj.getSalary());
            System.out.println("Employee SSN: " + Neeraj.getSsn());
        }
}
